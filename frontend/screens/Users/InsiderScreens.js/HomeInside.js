...
import Mentor from '../Major/Mentor';
const HomeInside = ({navigation, route}) => {
  ...
  return (
    ...
    >  
      ...
      <Stack.Screen name="HomeInsider" component={Home} />
       ...
       <Stack.Screen name='Mentors' component={Mentor} />
       <Stack.Screen 
  name='Cer' 
