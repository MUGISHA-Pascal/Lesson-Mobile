...
const Login = ({ navigation }) => {
  ...
  const handleLogin = async () => {
    ...
    if (phoneNumber.trim() == "") {
      setEmailread("*Please phone number required")
      setTimeout(()=>{
      ...
      setPasswordred("*Please pin number required")
      setTimeout(()=>{
    ...
    if (go) {
      try {
        ...
        console.log('The id is',response.data)
          ...
          <View style={styles.All_combined_container}>
            ...
            <View style={{ marginTop: 40 }}>
              {incorect && <Message_info type="error" message="Please check your email and password collectly" />
               ...
               <View style={{...styles.phoneInputContainer,borderColor:emailread ? "red" : onFocusemail ?  "#0961F5":"rgba(236, 236, 236,0.4)", borderWidth:2}}>
                              <PhoneInput
