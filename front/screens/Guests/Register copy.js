      ...
      <View style={styles.All_combined_container}>
        ...
        <View style={{ marginTop: 40 }}>
          ...
          <View style={styles.inputContainer}>
            <Fontisto name="email" size={20} color="#545454" style={styles.icon} />
            <TextInput
              style={styles.input}
              placeholder="Email"
        ...
        <View style={styles.stepsContainer}>
          ...
          <TouchableOpacity onPress={()=>navigation.navigate("FullInfo")} style={styles.nextButton}>
            <View>
          ...
          <TouchableOpacity onPress={()=>navigation.navigate("Login")} style={styles.nextButton2}>
